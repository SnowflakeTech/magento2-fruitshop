<?php
namespace Magepow\Core\Console\Command\CleanUp;

/**
 * Interceptor class for @see \Magepow\Core\Console\Command\CleanUp
 */
class Interceptor extends \Magepow\Core\Console\Command\CleanUp implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(?\Symfony\Component\Filesystem\Filesystem $filesystem = null, ?\Magento\Framework\App\ResourceConnection $resource = null, ?string $name = null)
    {
        $this->___init();
        parent::__construct($filesystem, $resource, $name);
    }
